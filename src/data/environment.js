...
const environmentCore = [
  ...
  // Additional for polish
  {
    ...
    url: "https://grokipedia.com/asbestos"
  },
  {
    id: "benzene",
    name: "Benzene (Fuel, Smoke, Industry)",
    short: "BENZENE",
    cat: "air-pollution",
    impact: "negative",
    longevity: 30,
  ...
  {
    id: "blue-light",
    name: "Excessive Blue Light / HEV (Screens)",
    short: "BLUE LIGHT",
    cat: "radiation",
    impact: "negative",
    longevity: 45,
  ...
  {
    id: "pharmaceuticals-water",
    name: "Trace Pharmaceuticals in Water",
    short: "DRUGS IN WATER",
    cat: "water-contam",
    impact: "negative",
    longevity: 40,
    qol: 42,
    diseases: 7,
    organs: ["liver", "endocrine", "gut"],
    mechanisms: ["Hormone disruption, antibiotic resistance"],
    risks: "Endocrine effects, resistance, low-level toxicity",
    blurb: "From human excretion and improper disposal into waterways.",
